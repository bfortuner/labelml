...
def get_resnet18(pretrained, n_freeze, verbose=True):
    resnet = torchvision.models.resnet18(pretrained)
    if n_freeze > 0:
        models.utils.freeze_layers(resnet, n_freeze, verbose)
    return resnet


def get_resnet34(pretrained, n_freeze, verbose=True):
...
def get_resnet50(pretrained, n_freeze, verbose=True):
